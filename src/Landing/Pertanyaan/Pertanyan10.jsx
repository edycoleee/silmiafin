  ...
  return (
    <div className="flex flex-col items-center">
      <div className="m-[50px] flex flex-col items-center justify-center">
        <h3 className="text-5xl font-bold m-10">Pertanyaan 10</h3>
        <h3 className="text-4xl font-bold mt-10">Berapa hasil 20 kurang 3?</h3>
        <input type="text" placeholder="Tuliskan jawaban anda" className="bg-gray-100 w-[300px] p-2 m-[50px] rounded-md text-xl" />
        <h3 className="text-4xl font-bold mt-10">Lalu kurangi 3 lagi?</h3>
        <input type="text" placeholder="Tuliskan jawaban anda" className="bg-gray-100 w-[300px] p-2 m-[50px] rounded-md text-xl" />
        <h3 className="text-4xl font-bold mt-10">Dan di kurangi 3 lagi?</h3>
        <input type="text" placeholder="Tuliskan jawaban anda" className="bg-gray-100 w-[300px] p-2 m-[50px] rounded-md text-xl" />
        <button className="w-[300px] mt-10 py-3 bg-[#202020] hover:bg-[#272727] rounded-lg text-white text-xl">Selesai</button>
      </div>
