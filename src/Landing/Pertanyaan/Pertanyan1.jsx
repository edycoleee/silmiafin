  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex flex-col items-center justify-center">
        <h3 className="text-4xl font-bold m-10">Pertanyaan 1</h3>
        <h3 className="text-3xl">Tanggal Berapa hari ini?</h3>
        <input type="text" placeholder="Tuliskan jawaban anda" className="bg-gray-100 w-[300px] p-2 m-10 rounded-md text-1xl" />
        <button onClick={() => navigate("/menu/pengkajiankog/per2")} className="w-[250px] mt-10 py-2 bg-[#202020] hover:bg-[#272727] rounded-lg text-white">Pertanyan Berikutnya</button>
      </div>
